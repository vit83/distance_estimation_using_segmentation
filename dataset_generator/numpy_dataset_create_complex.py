...
def main():
    ...
    db_name = "noise_10snr_train_data_1_to_10_targets_max_range_1_10_train.npy"
    ...
    overlap_dist = signal_time_sec * Vp / 2
    ...
    for i in range(0, number_of_range_lists):
        ...
        for k in range(1, num_of_targets):
            ...
            if overlap == 1:
                ...
                range_list[k] = np.clip(range_list[rand_ind] + overlap_dist * np.random.normal() / 3, min_range_meter, max_range_meter)
            else:
